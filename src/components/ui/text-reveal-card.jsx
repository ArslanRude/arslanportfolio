...
export const TextRevealCard = ({
  ...
  return (
    (<div
      ...
      ref={cardRef}
      className={cn(
        "w-[32rem] rounded-mg p-3 relative overflow-hidden",
        className
      )}>
      {children}
      <div className="h-20  relative flex items-center overflow-hidden">
        <motion.div
          ...
          className="absolute bg-[#090a0a] z-20  will-change-transform">
          <p
            style={{
        ...
        <motion.div
          ...
          transition={isMouseOver ? { duration: 0 } : { duration: 0.4 }}
          className="h-20 w-[8px] bg-gradient-to-b from-transparent via-neutral-800 to-transparent absolute z-50 will-change-transform"></motion.div>
